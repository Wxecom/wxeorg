...
<%call CheckAuthority("strSelectProduct")%>
<html>
<head>
...
%>
<form id="form1" name="sample" method="post" action="selectproduct.asp">
...
<div align="center" class="style1">产品入库单查询</div>
<%
...
If Request.Form("depot1") = "" Then
    s_depotname = " and custname in ("&s_depotpower&"'a')"
Else
    s_depotname = " and custname='"&Request.Form("depot1")&"'"
End If
If Request.Form("depot2") = "" Then
    s_custname = " and depotname in ("&s_depotpower&"'a')"
Else
