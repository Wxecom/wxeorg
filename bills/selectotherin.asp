...
%>
<p align="left"><span class="STYLE1">其他入库查询</span></p>
...
<hr>
<input type="button" value="新增其他入库单" class="button" onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  onClick="NewBill();">
<%
