...
function NewBill(){
openwin('lingliaobill.asp', 900,600)
}
...
%>
<p align="left"><span class="STYLE1">领料单查询</span></p>
...
<hr>
<input type="button" value="新增部门领料单" onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  class="button" onClick="NewBill();">
<%
