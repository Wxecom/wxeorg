...
openwin('diaobobill.asp', 900,600)
}
...
%>
<p align="left"><span class="STYLE1">调拨单查询</span></p>
<table align="left"><tr><td>
<form name="form1" method="post" action="selectdiaobo.asp">
<table border="0">
<tr>
...
<hr>
<input type="button" value="新增仓库调拨单" onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  class="button" onClick="NewBill();">
<%
