...
<% call CheckAuthority("strGoodsBuyDetail") %>
<html>
<head>
...
%>
<br>
<form id="form1" name="sample" method="post" action="goodsbuydetail.asp">
<div align="left"><span class="style1">采购明细表</span></div>
