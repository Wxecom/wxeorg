...
%>
<br>
<form id="form1" name="sample" method="post" action="goodsbuycount.asp">

<div align="left"><span class="style1">货品采购汇总表</span></div>
